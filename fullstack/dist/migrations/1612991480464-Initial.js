...
exports.Initial1612991480464 = void 0;
class Initial1612991480464 {
    constructor() {
        this.name = 'Initial1612991480464';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "text" character varying NOT NULL, "points" integer NOT NULL DEFAULT '0', "title" character varying NOT NULL, "creatorId" integer NOT NULL, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
...
exports.Initial1612991480464 = Initial1612991480464;
//# sourceMappingURL=1612991480464-Initial.js.map